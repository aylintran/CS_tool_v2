...
| **`crisp-plugin-integration`** | Sidebar Plugin tích hợp Crisp Chat: Tab Tickets, Tab Store Info, phát bài Slack Thread dưới tên CS (User OAuth Token), Cảnh báo lỗi kết nối Slack kèm nút `Resend`. | [`01-srs.md`](file:///E:/ABC%20soft%20files/CS_tool_v2/docs/phases/phase-1-helpdesk-os/features/crisp-plugin-integration/01-srs.md) |
| **`shop-detail-360`** | Màn hình Shop 360° View: Ô Search Domain, Account Info, Needs Action (`URGENT`, `REVIEWS < 3★`), CS Pinned Notes, Tính năng **Add Sub-domain**, Hiển thị 100% thẻ ticket 2 cột đầy đủ. | [`01-srs.md`](file:///E:/ABC%20soft%20files/CS_tool_v2/docs/phases/phase-1-helpdesk-os/features/shop-detail-360/01-srs.md) |
| **`cs-workflow-guide-documentation`** | Màn hình Hướng dẫn Quy trình CS (`📖 CS Workflow Guide`) dạng Accordion đóng/mở linh hoạt: Sơ đồ luồng 4 bước, Quy trình Follow-up thủ công, 12 Trạng thái Custom, 2 Thẻ ghi chú vàng. | [`01-srs.md`](file:///E:/ABC%20soft%20files/CS_tool_v2/docs/phases/phase-1-helpdesk-os/features/cs-workflow-guide-documentation/01-srs.md) |
| **`app-store-reviews-tracking`** | Màn hình Theo dõi Review Shopify App Store: Rating breakdown, Top complaint themes, 3-way auto linking Crisp Chat ID, Nút `Create ticket`, `Crisp`, `Store Info`. | [`01-srs.md`](file:///E:/ABC%20soft%20files/CS_tool_v2/docs/phases/phase-1-helpdesk-os/features/app-store-reviews-tracking/01-srs.md) |
